...
<section id="content">
    ...
    @include("partials.part-event-main")
...
<div class="container clear-bottommargin clearfix">
            ...
            <div class="col-md-3 col-sm-12 ">
                <div class="ipost clearfix">
                    ...
                    <div class="entry-title">
                        <h3><a href="{{ url('/blog/'.$g_post_cat_1 -> slug) }}">{{ $g_post_cat_1->title }} </a></h3>
                    </div>
    ...
    <a href="blog"
       class="button button-reveal button-border button-small button-rounded uppercase tright bottommargin"><span>Читать все статьи</span>
...
<div class="section dark nobottommargin">
    <div class="container clearfix">
        ...
        <a href="blog"
           class="button button-reveal button-border button-light button-small button-rounded uppercase tright noleftmargin topmargin-sm"><span>Читать весь Блог</span>
            <i class="icon-angle-right"></i></a>
    </div>
</div>
...
<div class="section nomargin">
    ...
    {{-- <h3 class="center">Full Width Carousel</h3> --}}
