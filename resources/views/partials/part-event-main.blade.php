<div class="container bottommargin clearfix">
    ...
    <div class="col_full">
        ...
        <div class="fancy-title title-border">
            <h2>Тренинги: Scrum, Agile, Management30</h2>
        </div>

        <div class="col_one_third nobottommargin">
            <div class="ipost clearfix">
                <div class="entry-image">
                    <a href="scrum0"><img class="image_fade" src="images/scrum0-banner.jpg" alt="Image"></a>
                </div>
                ...
                <div class="entry-content">
                    <p>Тренинг для начинающих свой путь в Scrum и тех, у кого практический опыт меньше 3 лет.
                        Тренинг поможет полностью увидеть картину Scrum и почувствовать в деталях все его основные
                        аспекты.</p>
                </div>
                <a href="scrum0"
        ...
        <div class=" col_one_third nobottommargin">
            <div class="ipost clearfix">
                <div class="entry-image">
                    <a href="master-of-scrum"><img class="image_fade" src="images/master-scrum-banner.jpg" alt="Image"></a>
                </div>
                <div class="entry-title">
                ...
                <div class="entry-content">
                    <p>Игровой тренинг для управленцев, желающих узнать все самые важные аспекты Scrum от А до Я, и
                        получить набор практических инструментов по использованию Scrum у себя в организациях. </p>
                </div>
