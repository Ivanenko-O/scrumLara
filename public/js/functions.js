...
(function($){
	...
	SEMICOLON.header = {
		...
		init: function(){
			...
			$(window).on('scroll', SEMICOLON.header.headerContact);
			// SEMICOLON.header.headerContact();
		...
		headerContact: function() {
			if ($(window).scrollTop()>60){
				// $('.top-links').addClass('hidden ');
				$('.top-links-tel').removeClass('hidden');
			} else if ($(window).scrollTop()== 0 && ($(window).scrollTop()<45)) {
				$('#header-contact').addClass('hidden');
			}
		},
	...
	$(function () {
		$('#primary-menu a').each(function () {
			...
			if(result != null) {
				...
				// $(this).closest('.mega-menu').addClass('current');
				// $(this).closest("ul").find("li").removeClass("current");
				$(this).parents('#primary-menu ul>li').addClass('current');
				$('ul > li.mega-menu-title').removeClass('current');
			}
		});
	});
